 ...
 * @author hrfan
 */
public class Dsjbxx implements CombotreeDefine {
    ...
    public List<String> getSupportedParentDefines() {
        ...
        supportedParentDefines.add("szyx");
    ...
    public List<Map<String, Object>> getData() {
        ...
        try {
            ...
            if (parentValue == null || "".equals(parentValue.toString().trim())) {
                ...
                sql.append("SELECT yxdm,yxmc FROM t_xb_dw dw WHERE yxdm in (SELECT DISTINCT(szyx) FROM t_xkjs_dsgl_dsjbxx)");
                ...
                StringBuilder sql = new StringBuilder();
                sql.append("SELECT zgh,xm FROM t_xkjs_dsgl_dsjbxx WHERE szyx = ?");
    ...
    public Map<Object, String> getVFLs() {
        ...
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT zgh,xm FROM t_xkjs_dsgl_dsjbxx");
        try {
            dbUtil.execute(sql.toString(), new IResultSetProcessor() {
