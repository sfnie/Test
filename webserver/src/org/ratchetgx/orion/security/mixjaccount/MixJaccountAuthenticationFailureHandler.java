 ...
 * @author hrfan
 */
public class MixJaccountAuthenticationFailureHandler extends
	...
	public MixJaccountAuthenticationFailureHandler() {
	}

	public MixJaccountAuthenticationFailureHandler(String defaultFailureUrl) {
